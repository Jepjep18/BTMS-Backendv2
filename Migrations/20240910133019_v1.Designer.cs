            ...
            modelBuilder.Entity("api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 9, 10, 21, 30, 18, 496, DateTimeKind.Local).AddTicks(6462),
                            Email = "admin@abfiph.com",
                            FirstName = "Admin",
                            LastName = "User",
                            MiddleName = "Admin",
                            PasswordHash = "$2a$11$rjMdjmJqh83g3Jm8CBCHo.w8HpEs2vSoBlvzFW.fPNceGAAjrBKFy",
                            Role = "Admin",
                            Username = "000-001"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 9, 10, 21, 30, 18, 659, DateTimeKind.Local).AddTicks(7468),
                            Email = "warehouse@abfiph.com",
                            FirstName = "Warehouse",
                            LastName = "User",
                            MiddleName = "Test",
                            PasswordHash = "$2a$11$SxAQpLDbiF.ag0DgkTPP3uK0cz53GN6L3PEnORBBFsuBi1LjqU5YS",
                            Role = "FAIPwarehouse",
                            Username = "000-002"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 9, 10, 21, 30, 18, 819, DateTimeKind.Local).AddTicks(5526),
                            Email = "faipAdmin@abfiph.com",
                            FirstName = "FAIP",
                            LastName = "User",
                            MiddleName = "Admin",
                            PasswordHash = "$2a$11$BWik4O3gOuwYgHGbgFrRzutrL/2J6Hf4wHzJ64uaF5jYHIB1smOtC",
                            Role = "FAIPadmin",
                            Username = "000-003"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 9, 10, 21, 30, 18, 986, DateTimeKind.Local).AddTicks(5050),
                            Email = "businessunit@abfiph.com",
                            FirstName = "Business",
                            LastName = "User",
                            MiddleName = "Unit",
                            PasswordHash = "$2a$11$.pDOV762yVHPSd41PEkB0Oc4eVKmS76xRigEx6lcNzKU2HQXsajBS",
                            Role = "BusinessUnit",
                            Username = "000-004"
                        });
                });
