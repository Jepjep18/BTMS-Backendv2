            ...
            modelBuilder.Entity("api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 9, 11, 9, 25, 46, 678, DateTimeKind.Local).AddTicks(8331),
                            Email = "admin@abfiph.com",
                            FirstName = "Admin",
                            LastName = "User",
                            MiddleName = "Admin",
                            PasswordHash = "$2a$11$RAUahv8knpsGY/vDfEa6yuVnS9NaNJSC7.swPJAfp0EMEggf9.BRq",
                            Role = "Admin",
                            Username = "000-001"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 9, 11, 9, 25, 46, 824, DateTimeKind.Local).AddTicks(8765),
                            Email = "warehouse@abfiph.com",
                            FirstName = "Warehouse",
                            LastName = "User",
                            MiddleName = "Test",
                            PasswordHash = "$2a$11$9LxgJz.8uuCVrt8Kr2DM6ub9BPVSgoG2sT.bzlBMnImjjuKW0fhQO",
                            Role = "FAIPwarehouse",
                            Username = "000-002"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 9, 11, 9, 25, 46, 971, DateTimeKind.Local).AddTicks(385),
                            Email = "faipAdmin@abfiph.com",
                            FirstName = "FAIP",
                            LastName = "User",
                            MiddleName = "Admin",
                            PasswordHash = "$2a$11$1Ht4cEtVCcGa/jDd9rm/DONqIqD8wJZbL4ii6Mlgf24JLVjC6Inpe",
                            Role = "FAIPadmin",
                            Username = "000-003"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 9, 11, 9, 25, 47, 115, DateTimeKind.Local).AddTicks(3556),
                            Email = "businessunit@abfiph.com",
                            FirstName = "Business",
                            LastName = "User",
                            MiddleName = "Unit",
                            PasswordHash = "$2a$11$pKEGoEo31EkcCa0ZxbH8E.zx4rBHKac8vpbaSgWrAQnBxr6nhOgAK",
                            Role = "BusinessUnit",
                            Username = "000-004"
                        });
                });
